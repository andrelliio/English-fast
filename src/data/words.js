...
// ══════════════════════════════════════════════════════════════════
//
// type: "phrase"  — фразовый блок (основной контент)
// type: "word"    — отдельное слово-существительное (словарь)
// type: "glue"    — связующее слово / филлер для естественной речи
//
    ...
    lessons: [
      ...
      },
      {
        ...
        exercises: [
          ...
          { ru: "Он стал врачом", en: ["He", "became", "a", "doctor"], category: "past_affirmative", verbBase: "become" },
          { ru: "Погода стала прохладной", en: ["The", "weather", "became", "cool"], category: "past_affirmative", verbBase: "become" },
          { ru: "Она ушла рано", en: ["She", "left", "early"], category: "past_affirmative", verbBase: "leave" },
          { ru: "Они уехали вчера", en: ["They", "left", "yesterday"], category: "past_affirmative", verbBase: "leave" },
          { ru: "Они положили это здесь", en: ["They", "put", "it", "here"], category: "past_affirmative", verbBase: "put" },
          { ru: "Я положил книгу в сумку", en: ["I", "put", "the", "book", "in", "the", "bag"], category: "past_affirmative", verbBase: "put" },
          { ru: "Я имел в виду другое", en: ["I", "meant", "something", "else"], category: "past_affirmative", verbBase: "mean" },
          { ru: "Это много значило для меня", en: ["It", "meant", "a", "lot", "to", "me"], category: "past_affirmative", verbBase: "mean" },
          { ru: "Мы сохранили секрет", en: ["We", "kept", "a", "secret"], category: "past_affirmative", verbBase: "keep" },
          { ru: "Он сохранил свое слово", en: ["He", "kept", "his", "word"], category: "past_affirmative", verbBase: "keep" },
      ...
      },
      {
        ...
        exercises: [
          ...
          { ru: "Мы слышали шум", en: ["We", "heard", "a", "noise"], category: "past_affirmative", verbBase: "hear" },
          { ru: "Он пробежал 5 миль", en: ["He", "ran", "five", "miles"], category: "past_affirmative", verbBase: "run" },
          { ru: "Они бежали очень быстро", en: ["They", "ran", "very", "fast"], category: "past_affirmative", verbBase: "run" },
          { ru: "Она держала ребенка", en: ["She", "held", "the", "baby"], category: "past_affirmative", verbBase: "hold" },
          { ru: "Мы держались за руки", en: ["We", "held", "hands"], category: "past_affirmative", verbBase: "hold" },
          { ru: "Он написал письмо", en: ["He", "wrote", "a", "letter"], category: "past_affirmative", verbBase: "write" },
          { ru: "Я написал свое имя", en: ["I", "wrote", "my", "name"], category: "past_affirmative", verbBase: "write" },
          { ru: "Они стояли в очереди", en: ["They", "stood", "in", "line"], category: "past_affirmative", verbBase: "stand" },
          { ru: "Он стоял у окна", en: ["He", "stood", "by", "the", "window"], category: "past_affirmative", verbBase: "stand" },
          { ru: "Я потерял свои ключи", en: ["I", "lost", "my", "keys"], category: "past_affirmative", verbBase: "lose" },
          { ru: "Команда проиграла игру", en: ["The", "team", "lost", "the", "game"], category: "past_affirmative", verbBase: "lose" }
        ]
      },
      {
        id: "exam_30",
      ...
      },
      {
        ...
        exercises: [
          ...
          { ru: "Мы встретились вчера", en: ["We", "met", "yesterday"], category: "past_affirmative", verbBase: "meet" },
          { ru: "Она встретила друга", en: ["She", "met", "a", "friend"], category: "past_affirmative", verbBase: "meet" },
          { ru: "Он установил рекорд", en: ["He", "set", "a", "record"], category: "past_affirmative", verbBase: "set" },
          { ru: "Я установил будильник", en: ["I", "set", "the", "alarm"], category: "past_affirmative", verbBase: "set" },
          { ru: "Он выучил правило", en: ["He", "learned", "the", "rule"], category: "past_affirmative", verbBase: "learn" },
          { ru: "Она выучила новый язык", en: ["She", "learned", "a", "new", "language"], category: "past_affirmative", verbBase: "learn" },
      ...
      },
      {
        ...
        exercises: [
          ...
          { ru: "Он построил дом", en: ["He", "built", "a", "house"], category: "past_affirmative", verbBase: "build" },
          { ru: "Яблоко упало", en: ["The", "apple", "fell"], category: "past_affirmative", verbBase: "fall" },
          { ru: "Я упал на льду", en: ["I", "fell", "on", "the", "ice"], category: "past_affirmative", verbBase: "fall" },
          { ru: "Он порезал палец", en: ["He", "cut", "his", "finger"], category: "past_affirmative", verbBase: "cut" },
          { ru: "Она разрезала торт", en: ["She", "cut", "the", "cake"], category: "past_affirmative", verbBase: "cut" },
          { ru: "Мы потратили все деньги", en: ["We", "spent", "all", "the", "money"], category: "past_affirmative", verbBase: "spend" },
          { ru: "Я провел (потратил) выходные там", en: ["I", "spent", "the", "weekend", "there"], category: "past_affirmative", verbBase: "spend" },
          { ru: "Они выиграли игру", en: ["They", "won", "the", "game"], category: "past_affirmative", verbBase: "win" },
          { ru: "Я выиграл приз", en: ["I", "won", "a", "prize"], category: "past_affirmative", verbBase: "win" },
          { ru: "Он сидел на стуле", en: ["He", "sat", "on", "a", "chair"], category: "past_affirmative", verbBase: "sit" },
          { ru: "Мы сидели там", en: ["We", "sat", "there"], category: "past_affirmative", verbBase: "sit" },
          { ru: "Мяч ударился о стену", en: ["The", "ball", "hit", "the", "wall"], category: "past_affirmative", verbBase: "hit" },
          { ru: "Он разбил чашку", en: ["He", "broke", "a", "cup"], category: "past_affirmative", verbBase: "break" },
          { ru: "Она сломала ногу", en: ["She", "broke", "her", "leg"], category: "past_affirmative", verbBase: "break" },
          { ru: "Она принесла цветы", en: ["She", "brought", "flowers"], category: "past_affirmative", verbBase: "bring" },
          { ru: "Они принесли еду", en: ["They", "brought", "food"], category: "past_affirmative", verbBase: "bring" }
        ]
      },
      {
        id: "exam_50",
      ...
      },
      {
        ...
        exercises: [
          ...
          { ru: "Он вел машину (ехал на машине)", en: ["He", "drove", "a", "car"], category: "past_affirmative", verbBase: "drive" },
          { ru: "Мы ехали всю ночь", en: ["We", "drove", "all", "night"], category: "past_affirmative", verbBase: "drive" },
          { ru: "Он забыл мой номер", en: ["He", "forgot", "my", "number"], category: "past_affirmative", verbBase: "forget" },
          { ru: "Я забыл свои ключи", en: ["I", "forgot", "my", "keys"], category: "past_affirmative", verbBase: "forget" },
          { ru: "Мы выбрали этот отель", en: ["We", "chose", "this", "hotel"], category: "past_affirmative", verbBase: "choose" },
          { ru: "Она выбрала красное платье", en: ["She", "chose", "a", "red", "dress"], category: "past_affirmative", verbBase: "choose" },
      ...
      },
      {
        ...
        exercises: [
          ...
          { ru: "Они продали дом", en: ["They", "sold", "the", "house"], category: "past_affirmative", verbBase: "sell" },
          { ru: "Мы пили чай", en: ["We", "drank", "tea"], category: "past_affirmative", verbBase: "drink" },
          { ru: "Я выпил воды", en: ["I", "drank", "water"], category: "past_affirmative", verbBase: "drink" },
          { ru: "Она пела красиво", en: ["She", "sang", "beautifully"], category: "past_affirmative", verbBase: "sing" },
          { ru: "Мы пели песню", en: ["We", "sang", "a", "song"], category: "past_affirmative", verbBase: "sing" },
          { ru: "Он проплыл милю", en: ["He", "swam", "a", "mile"], category: "past_affirmative", verbBase: "swim" },
          { ru: "Она лежала на траве", en: ["She", "lay", "on", "the", "grass"], category: "past_affirmative", verbBase: "lie" },
