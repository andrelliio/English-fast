...
const slides = [
  ...
  },
  {
    ...
    desc: 'Остров — это мини-словарь для ситуаций. Вместо отдельных слов мы учим готовые фразы и связки, которые сразу можно применять в речи.'
  },
  {
    icon: '🧠',
    title: 'Как это работает',
    desc: 'Учи карточки 🃏, сдавай тесты ⚡ и открывай новые острова. Система сама подбросит карточки из старых тем для повторения 🔄'
  }
];
